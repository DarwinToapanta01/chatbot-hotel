      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px' }}>
          <div>
            ...
            <p style={{ fontSize: '13px', color: '#4f6466', marginTop: '4px' }}>Accede al panel de administración</p>
          </div>
          <button
            onClick={onClose}
            style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#a1c2c6', fontSize: '20px', lineHeight: 1, padding: '4px' }}
          >✕</button>
        </div>
